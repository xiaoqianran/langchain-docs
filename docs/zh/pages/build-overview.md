...
使用 LangChain、LangGraph 和 Deep Agents 构建代理。
...
<div>
  <div>
    ...
    Deep Agents、LangChain和LangGraph共享相同的堆栈，因此请根据您需要的控制程度进行选择：
...
<div>
  ...
  <Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/build-overview.mdx) 或 [file an issue](https://github.com/langchain-ai/docs/issues/new/choose)。
  </Callout>
</div>


# 
来源：https://docs.langchain.com/index
...
<div>
  <div>
    ...
    一个可以改进代理开发生命周期每一步的平台，以便您可以更快地交付可靠的代理。
    <h2>代理开发生命周期</h2>

    <CardGroup>
      <Card title="Build" icon="hammer" href="/build-overview">
        使用 LangChain、LangGraph 和 Deep Agents 的代码构建代理。
      </Card>

      <Card title="Test" icon="flask" href="/langsmith/evaluation">
        使用数据集、评估和即时工程来评估代理。
      </Card><Card title="Deploy" icon="rocket" href="/langsmith/deployment">
        大规模部署和服务代理。
      </Card>
    ...
    <CardGroup>
      ...
      <Card title="Deep Agents Code" icon="code" href="/oss/deepagents/code/overview">
        使用开源`dcode` CLI 在终端中使用 AI 代理进行编码。
      </Card>
    </CardGroup>
    ...
    <CardGroup>
      ...
      </Card><Card title="Trust Center" icon="shield-lock" href="https://trust.langchain.com/">
        HIPAA、SOC 2 Type 2 和 GDPR 合规性详细信息。
      </Card>
    </CardGroup>
  </div>
</div>