...
LangSmith 审核日志提供组织内所采取的管理和配置操作的防篡改记录。他们帮助您回答以下问题：
...
[Open Cybersecurity Schema Framework (OCSF)](https://schema.ocsf.io/) 是安全事件数据的开放标准。 LangSmith 将审核日志事件返回为 OCSF v1.7.0 API 活动（类 6003）对象。
</Accordion>
</AccordionGroup>
