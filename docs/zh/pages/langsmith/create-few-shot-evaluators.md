...
使用少量示例，人工更正会自动插入到您的评估器提示中。 Few-shot Examples 是一种受 [few-shot prompting](https://www.promptingguide.ai/techniques/fewshot) 启发的技术，它通过一些高质量的示例来指导模型输出。
...
<img alt="Edit Evaluator" />前往 **使用少量示例提高评估器准确性** 部分中链接的修正数据集。您可以查看和更新​​数据集中的少量示例。
