...
- [Plus plan or above](https://www.langchain.com/pricing) 上的[LangSmith account](https://smith.langchain.com?utm_source=docs&utm_medium=cta&utm_campaign=langsmith-signup&utm_content=langsmith-deployment-quickstart) 和[API key](/langsmith/create-account-api-key)。
...
1. 选择您的部署以查看其详细信息。
1. 点击右上角**Studio**，打开[Studio](/langsmith/studio)。

## 5. 测试 API

从部署详细信息视图中复制 **API URL**，然后使用它来调用您的应用程序：<Tabs>
