...
3. **支持**：已弃用的端点将在最短的时间内继续运行，具体取决于您的部署。参见[Deprecation window by deployment](#deprecation-window-by-deployment)。
...
- [Release stages](/langsmith/release-stages) 了解功能如何从 alpha 过渡到 GA
