...
该管道将生成类似于以下内容的跟踪：<img alt="evaluation_intermediate_trace.png" />
...
<CodeGroup>
  ...
  ```
</CodeGroup>实验将包含评估结果，包括评估者的分数和评论：<img alt="evaluation_intermediate_experiment.png" />
