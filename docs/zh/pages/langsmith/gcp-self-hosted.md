...
- <Icon icon="sparkles" /> **LLM 集成：** 可选择将请求代理到 [Gemini Enterprise Agent Platform](https://cloud.google.com/products/gemini-enterprise-agent-platform) 以进行 LLM 推理。
...
- 从 [Gemini Enterprise Agent Platform](https://cloud.google.com/products/gemini-enterprise-agent-platform) 上运行的 LLM 应用程序捕获跟踪。
