...
## 指令与其他概念的比较将 [skills](/langsmith/javascript/managed-deep-agents-skills) 用于代理仅在相关时加载的特定于任务的过程。使用 [memory](/langsmith/javascript/managed-deep-agents-memory) 来获取代理跨线程学习和保留的知识。
