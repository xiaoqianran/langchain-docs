...
* **[MCP connectors](/langsmith/javascript/managed-deep-agents-mcp-connectors)**：为代理提供工具的远程MCP服务器。
...
* **记忆**：[Managed memory](/langsmith/javascript/managed-deep-agents-memory) 让代理记住交互过程中的信息。
