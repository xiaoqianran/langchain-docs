...
对于应该始终由代理加载的行为，请使用 [instructions](/langsmith/javascript/managed-deep-agents-instructions)。

使用[memory](/langsmith/javascript/managed-deep-agents-memory)获取您希望代理能够更新的知识。
