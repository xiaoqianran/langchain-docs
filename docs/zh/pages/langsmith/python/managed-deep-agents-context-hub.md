...
有关托管运行时字段的所有权，请参阅[Agent definition](/langsmith/python/managed-deep-agents-agent-definition)。
...
有关完整的部署步骤列表和标志，请参阅 [CLI reference](/langsmith/python/managed-deep-agents-cli#deploy-projects)。有关秘密路由和部署选项，请参阅[Deploy an agent](/langsmith/python/managed-deep-agents-deploy)。
...
## 选择上下文所属的位置|目标|使用 |
| ---| ---|
|永远在线的系统提示 | [Instructions](/langsmith/python/managed-deep-agents-instructions) |
|特定任务的程序 | [Skills](/langsmith/python/managed-deep-agents-skills) |
|代理跨线程学习和保留的知识 | [Memory](/langsmith/python/managed-deep-agents-memory) |
|应用逻辑和外部调用| [Tools](/langsmith/python/managed-deep-agents-tools)、[MCP connectors](/langsmith/python/managed-deep-agents-mcp-connectors) 或 [middleware](/langsmith/python/managed-deep-agents-middleware) |
