...
[Managed Deep Agents](/langsmith/python/managed-deep-agents-overview) 包括由 [Parallel](https://parallel.ai) 提供支持的内置网络搜索。让您的代理能够访问网络上的最新信息以帮助回答问题。
...
您需要现有的 [Managed Deep Agents project](/langsmith/python/managed-deep-agents-quickstart)、LangSmith 工作区 ID 和个人 LangSmith API 密钥才能在 Studio 中使用。
