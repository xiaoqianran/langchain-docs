...
<!-- langchain-docs: How to run multiple assistants on the same thread | https://docs.langchain.com/langsmith/same-thread -->
...
您将看到第二个助手将使用第一个助手在线程中生成的 [checkpoint](/oss/python/langgraph/checkpointers#checkpoints) 中的信息作为上下文进行响应。
