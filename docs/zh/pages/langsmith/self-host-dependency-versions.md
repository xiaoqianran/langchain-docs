...
| [ClickHouse](/langsmith/self-host-external-clickhouse) | [LangSmith Helm chart](https://github.com/langchain-ai/helm/releases) 或更高 | 中指定的版本存储痕迹和反馈。 ClickHouse 24.2 或更高版本需要 LangSmith v0.6 或更高版本。不支持降级。 |
