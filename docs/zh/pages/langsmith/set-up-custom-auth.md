...
<img alt="No authentication: the dev server is publicly reachable, anyone can access the bot if exposed to the internet." />## 2.添加认证

现在您已经有了一个基础 LangGraph 应用程序，请为其添加身份验证。
...
现在您可以控制谁访问您的机器人，您可能想要：1. 继续教程，前往[Make conversations private](/langsmith/resource-auth)了解资源授权。
