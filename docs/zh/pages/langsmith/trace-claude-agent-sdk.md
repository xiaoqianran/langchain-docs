...
有关 Anthropic API 密钥，请参阅 [Claude console](https://claude.ai/login)。

## 快速入门

要为您的 Claude Agent SDK 应用程序启用 LangSmith 跟踪，请在应用程序开始时调用 `configure_claude_agent_sdk()`：
...
配置完成后，所有 Claude Agent SDK 操作都会自动追踪到 LangSmith，包括：
