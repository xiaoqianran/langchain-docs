...
[Claude Managed Agents](https://docs.anthropic.com/en/docs/claude-code/managed-agents) 是Anthropic 的托管、基于云的代理，在托管环境中运行。 LangSmith 支持通过 `wrapAnthropic` 包装器跟踪 Claude Managed Agent 会话，让您可以了解代理创建、会话事件和消息流。
