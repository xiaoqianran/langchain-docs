...
<!-- langchain-docs: Trace LangGraph applications | https://docs.langchain.com/langsmith/trace-with-langgraph -->
...
LangSmith UI 中的 **消息** 视图显示用户和代理之间的简化对话历史记录。该视图从顶级跟踪中提取消息（包括用户的初始请求、工具调用和代理的最终响应），并以类似聊天的格式表示它们。## 没有LangChain
