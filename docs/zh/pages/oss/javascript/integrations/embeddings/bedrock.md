...
<!-- langchain-docs: BedrockEmbeddings integration | https://docs.langchain.com/oss/javascript/integrations/embeddings/bedrock -->

# BedrockEmbeddings 集成

使用 LangChain JavaScript 与 BedrockEmbeddings 嵌入模型集成。
...
如果您想自定义选项，您可以传入您自己的 `BedrockRuntimeClient` 实例
`credentials`、`region`、`retryPolicy`等
...
有关所有 Bedrock 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/javascript/langchain-aws/BedrockEmbeddings)。
...
<div>
  ...
  <Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/bedrock.mdx) 或 [file an issue](https://github.com/langchain-ai/docs/issues/new/choose)。
  </Callout>
</div>