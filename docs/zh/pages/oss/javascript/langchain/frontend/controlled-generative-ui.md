...
受控生成 UI 位于作者控制端
[generative UI spectrum](/oss/javascript/langchain/frontend/generative-ui-overview)。你写的
...
预测，跨越二次互动的长尾，更进一步
沿着光谱到[declarative generative UI](/oss/javascript/langchain/frontend/declarative-generative-ui)。
...
请参阅 [Tool calling](/oss/javascript/langchain/frontend/tool-calling) 模式。
...
请参阅前端概述中的[typed agent state](/oss/javascript/langchain/frontend/overview)。
...
请参阅 [Reasoning tokens](/oss/javascript/langchain/frontend/reasoning-tokens) 图案。
