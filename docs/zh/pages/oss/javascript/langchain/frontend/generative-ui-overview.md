...
<!-- langchain-docs: Generative UI overview | https://docs.langchain.com/oss/javascript/langchain/frontend/generative-ui-overview -->
...
详情请参见[Controlled generative UI](/oss/javascript/langchain/frontend/controlled-generative-ui)。
...
详情请参见[Open-ended generative UI](/oss/javascript/langchain/frontend/open-ended-generative-ui)。
