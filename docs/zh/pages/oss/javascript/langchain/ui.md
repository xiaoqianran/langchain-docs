...
<!-- langchain-docs: Agent Chat UI | https://docs.langchain.com/oss/javascript/langchain/ui -->
...
代理聊天 UI 可以连接到 [local](/oss/javascript/langchain/studio) 和 [deployed agents](/oss/javascript/langchain/deploy)。启动代理聊天 UI 后，您需要将其配置为连接到您的代理：
...
<div>
  ...
  <Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/ui.mdx) 或 [file an issue](https://github.com/langchain-ai/docs/issues/new/choose)。
  </Callout>
</div>