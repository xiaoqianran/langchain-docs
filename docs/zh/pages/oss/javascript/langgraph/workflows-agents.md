...
<!-- langchain-docs: Workflows and agents | https://docs.langchain.com/oss/javascript/langgraph/workflows-agents -->
...
<Tip>
  跟踪并比较这些工作流程模式与[LangSmith](https://smith.langchain.com?utm_source=docs\&utm_medium=cta\&utm_campaign=langsmith-signup\&utm_content=oss-langgraph-workflows-agents)。按照[tracing quickstart](/langsmith/trace-with-langgraph)查看数据如何流经每个步骤。我们建议您还设置 [LangSmith Engine](/langsmith/engine) 来监视您的痕迹、检测问题并提出修复建议。
</Tip>
