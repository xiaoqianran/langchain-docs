...
<!-- langchain-docs: LangGraph v1 migration guide | https://docs.langchain.com/oss/javascript/migrate/langgraph-v1 -->
...
|面积 |发生了什么变化|
| -------------------------------- | ---------------------------------------------------------------------- |
|反应预建 | `createReactAgent` 已弃用；使用LangChain`createAgent` |
