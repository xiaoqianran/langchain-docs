...
<!-- langchain-docs: Reference | https://docs.langchain.com/oss/javascript/reference/overview -->

# 参考

LangChain 和 LangGraph Python 和 TypeScript 库的综合 API 参考文档。
...
<CardGroup>
  ...
  <Card title="LangGraph" icon="https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langgraph-icon.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=b997e1a7487d507a36556eedbfd99f81" href="https://reference.langchain.com/javascript/langchain-langgraph">
    LangGraph JavaScript/TypeScript 的完整 API 参考，包括图形 API、状态管理、检查点等。
  </Card>
...
<div>
  ...
  <Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/reference/overview.mdx) 或 [file an issue](https://github.com/langchain-ai/docs/issues/new/choose)。
  </Callout>
</div>