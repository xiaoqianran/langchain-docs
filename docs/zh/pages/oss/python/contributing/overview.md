...
<AccordionGroup>
  ...
  <Accordion title="Suggest features" icon="wand">
    ...
    <Card title="How to propose changes to the documentation" href="/oss/python/contributing/documentation">指南</Card>
  </Accordion>

  <Accordion title="Contribute code" icon="code">
    由于用户群庞大，我们的小团队可能很难跟上所有功能请求和错误修复。如果您有能力和时间，我们将非常乐意您的帮助！

    <Card title="How to make your first Pull Request" href="/oss/python/contributing/code">指南</Card>
  ...
  <Accordion title="Build a new integration" icon="plug-connected">
    ...
    <Card title="LangChain" icon="link" href="/oss/python/contributing/integrations-langchain">LangChain集成构建指南</Card>
    <Card title="Deep Agents sandboxes" icon="cube" href="/oss/python/contributing/integrations-langchain">构建沙箱集成指南</Card>
  </Accordion>
</AccordionGroup>
