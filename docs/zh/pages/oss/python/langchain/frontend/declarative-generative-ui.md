...
<!-- langchain-docs: Declarative generative UI | https://docs.langchain.com/oss/python/langchain/frontend/declarative-generative-ui -->
...
声明式生成 UI 位于中间
[generative UI spectrum](/oss/python/langchain/frontend/generative-ui-overview)。代理发出一个
结构化规范，前端根据以下目录组成界面
...
[controlled generative UI](/oss/python/langchain/frontend/controlled-generative-ui)。当
...
将 CopilotKit 连接到 LangGraph 部署，请参阅 [CopilotKit](/oss/python/langchain/frontend/integrations/copilotkit)。
