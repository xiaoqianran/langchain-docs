...
<!-- langchain-docs: Overview | https://docs.langchain.com/oss/python/langchain/frontend/integrations/overview -->
...
这四个都与 LangChain 代理配合良好，后三个也直接连接到[⟦T14⟧](https://reference.langchain.com/javascript/langchain-react/index/useStream)。当您需要更丰富的运行时层和可以与 [LangGraph](/oss/python/langgraph/overview) 部署并存的专用端点时，CopilotKit 特别有用。
