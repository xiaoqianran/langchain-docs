...
<!-- langchain-docs: Open-ended generative UI | https://docs.langchain.com/oss/python/langchain/frontend/open-ended-generative-ui -->
...
开放式生成 UI 位于代理创建的一端
[generative UI spectrum](/oss/python/langchain/frontend/generative-ui-overview)。界面是
